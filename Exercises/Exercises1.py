...
def areatriangle(b, h):
    print(f"The area of a triangle of base {b} and height {h} is {0.5*b*h}")
#%%
...
def celsius_to_fahrenheit(temp):
    newTemp=1.8*temp + 32
    print(f"The Celsius temperature {temp} is equivalent to {newTemp} degrees Fahrenheit.")
#%%
...
#%%
def count_down():
    ct = " ".join(map(str, list(range(10, 0, -1))))
    print(f"{ct} BLASTOFF!")
